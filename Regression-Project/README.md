...
For the storytelling document:
 - It will need to be delivered in a jupyter notebook named `Report.ipynb`
    - Between five and seven visualizations included.
    - It must include 2 statistical tests

For the machine learning model:
 - It should be demonstrated in the `Report.ipynb` notebook.
...
> The most important factors for property value are:
> - The location of the property
> - How large or small the property is
> - How old or historical the property is
